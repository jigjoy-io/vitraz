...
import TooltipButtonWrapper from "../../../components/shared/toolbar/tooltip-button-wrapper"
					...
					<m.div variants={animation} initial="hidden" animate="show" exit="exit" transition={transition}>
						<div className="border-l border-light shadow-lg fixed right-0 bottom-0 h-[100dvh] lg:w-[50%] bg-[white] flex flex-col">
							<div className="h-[24px] w-[24px] m-2" onClick={() => dispatch(sidebarExpanded({ expanded: false, component: null }))}>
								<TooltipButtonWrapper tooltip={<div className="text-[14px]">Close panel</div>}>
