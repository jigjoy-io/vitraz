...
export default function ExpandPage(props: any) {
	...
	return (
		<div onClick={(e) => toggleExpand(e)} className="flex items-center justify-center w-[24px] h-[24px] rounded-[4px] bg-[transparent] hover:bg-primary-light border-2 border-[transparent] rounded-md cursor-pointer">
