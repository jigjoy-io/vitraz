...
const CarouselConfigurer = lazy(() => import('../components/carousel/CarouselConfigurer'))
const PageTile = lazy(() => import('../components/page/PageTile'))
const PageConfigurer = lazy(() => import('../components/page/PageConfigurer'))
